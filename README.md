...
**Public extract:** 7,417 rows · **Live catalog:** 5,622,079 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/top?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_top_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/top?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_top_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./top.csv">CSV</a> / <a href="./top.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_top_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_top_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TOP search](https://unique.domains/domains/tld/top?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_top_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TOP search](https://unique.domains/domains/tld/top?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_top_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./top.csv) or [Download JSON](./top.json)
...
- `top.csv` — public CSV extract (7,417 rows)
- `top.json` — public JSON extract (7,417 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,417-row public sample | 5,622,079 live domains                           |
...
> Unique Domains. *Available .TOP One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
