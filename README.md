# Available .TOP One-Word Domains (9,691)
...
> The full live catalog for this exact search currently contains **9,691 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,691 domains · **Median ask:** $1,244.64 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,691 live domains                         |
...
> Unique Domains. *Available .TOP One-Word Domains*. Version 2026-05-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
