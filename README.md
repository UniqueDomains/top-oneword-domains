# Available .TOP One-Word Domains (9,692)
...
> The full live catalog for this exact search currently contains **9,692 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,692 domains · **Median ask:** $1,244.22 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,692 live domains                         |
...
> Unique Domains. *Available .TOP One-Word Domains*. Version 2026-05-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
